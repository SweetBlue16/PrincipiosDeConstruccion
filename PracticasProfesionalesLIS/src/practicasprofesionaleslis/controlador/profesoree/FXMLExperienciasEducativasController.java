...
public class FXMLExperienciasEducativasController implements Initializable {
    ...
    private void clicBtnSeleccionar(ActionEvent event) {
        ...
        // Aquí puedes implementar la lógica para manejar la experiencia seleccionada
        System.out.println("Experiencia seleccionada: " + experienciaSeleccionada.getNombre());
